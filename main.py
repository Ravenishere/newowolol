...
@bot.event
async def on_ready():
    activity = discord.Game(name="doing..your mom :D", type=4)
...
async def Owobanbypass(ctx):
    ...
    while dmcs:
        async with ctx.typing():
            ...
            await asyncio.sleep(18)
            await ctx.send('owo crate all')
            await asyncio.sleep(18)
            await ctx.send('owo sell commonweapons')
            await asyncio.sleep(18)
            await ctx.send('owo sell uncommonweapons')
            await asyncio.sleep(18)
            await ctx.send('owo sell rareweapons')
            await asyncio.sleep(18)
            await ctx.send('owo sell epicweapoons')
            await asyncio.sleep(18)
            await ctx.send('owo sell mythicweapons')
            await asyncio.sleep(18)
            await ctx.send('owo sell legendaryweapons')
            await asyncio.sleep(18)
            await ctx.send('owo sell fabledweapons')
